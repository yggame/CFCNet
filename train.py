        ...
        with torch.no_grad():
            if (epoch_val is not None) and (epoch % epoch_val == 0):
                ...
                if val_res > max_val_v:
                    max_val_v = val_res
                    torch.save(sv_file, os.path.join(save_path, 'epoch_best.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="./configs/train/train-cfcnet_rdn_mlp.yaml", type=str, help='config file path')
