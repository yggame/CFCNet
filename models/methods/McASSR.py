# https://github.com/GuangYuanKK/McASSR/blob/main/models/Network.py
# ICCV'2023 (多对比度)
...
from models.modules.LFEM import local_enhanced_blcok
...
class MC_ARSR(nn.Module):
    ...
    def gen_feat(self, inp):
        ...
        self.inp_feat = self.encoder(inp)
    ...
    def query_rgb(self, inp_hr_coord, inp_cell):
        ...
        for vx in vx_lst:
            for vy in vy_lst:
                inp_out, bs, q, rel_coord = self.RIA(inp_feat, inp_cell, inp_hr_coord, inp_feat_coord, inp_coef, inp_freq, vx, rx, vy, ry, eps_shift)
                merge = inp_out
    ...
    def RIA(self, feat, cell, coord, inp_feat_coord, inp_coef, inp_freq, vx, rx, vy, ry, eps_shift):
    ...
    def forward(self, inp, inp_hr_coord, inp_cell):
        self.gen_feat(inp)
